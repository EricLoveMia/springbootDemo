package com.loveprogrammer.springboot.thrift.annotation.client;

import com.loveprogrammer.springboot.thrift.annotation.server.HelloService;
import com.loveprogrammer.springboot.thrift.annotation.server.User;
