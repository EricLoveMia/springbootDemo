package com.loveprogrammer.springboot.thrift.server.service.thrift2;

import com.loveprogrammer.springboot.thrift.server.service.thrift.RPCDateService;
import com.loveprogrammer.springboot.thrift.server.service.thrift.RPCDateServiceImpl;
...
public class ThriftServer2 {
    ...
    public void start() {
        try {
            ...
            //泛型就是实现的业务
            RPCDateService.Processor<RPCDateServiceImpl> processor = new RPCDateService.Processor<>(rpcDateService);
