...
import cn.eric.springbootdemo.domain.*;
...
public class TokenController {
    ...
    public ApiResponse<AccessToken> apiToken(String appId
            , @RequestHeader("timestamp") String timestamp, @RequestHeader("sign") String sign){
...
//        String signString = timestamp + "1" + "12345678954556";
        ...
        String url = "productCode=TPIC_YWX_HKGTCKYWX&serviceType=2&channelCode=LINK5994941101826" +
                "&backUrl=http://c2b.zlbroker.com/c2b/html/ent/ent-standard/page/ent-standard.html?code=lmrlzl&from=singlemessage&isappinstalled=0";
