...
public class DataSourceConfiguration {
    ...
    private DataSource buildDataSource() throws SQLException {
        ...
        dataSourceMap.put("sharding0", createDataSource("sharding0"));
        ...
        DataSourceRule dataSourceRule = new DataSourceRule(dataSourceMap, "sharding0");
